...
def check_digit(raw_code):
    """
    Compute the check digit for an ISO 6346 without that digit.
...
def create(owner_code, serial, category="U"):
    ...
    Args:
        ...
        category (str): Equiment category indentifier.
    ...
    if category not in ('U', 'J', 'Z', 'R'):
        raise ValueError(f"Invalid ISO 6346 category indentifier '{category}'")
